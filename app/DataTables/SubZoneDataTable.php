...
class SubZoneDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return datatables()->eloquent($query)->addIndexColumn()
            ->editColumn('zone_id', function ($row) {
                return $row->zone->zone_name ? $row->zone->zone_name : $row->zone->zone_number;
            })
     ...
     *
     * @param \App\Models\SubZone $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(SubZone $model): QueryBuilder
    {
