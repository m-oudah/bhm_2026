...
class BuildingTypeDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\BuildingType $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BuildingType $model): QueryBuilder
    {
    ...
    {
        return 'BuildingType_' . date('YmdHis');
    }
}
