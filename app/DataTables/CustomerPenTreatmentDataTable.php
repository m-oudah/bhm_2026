...
class CustomerPenTreatmentDataTable extends DataTable
{
    /**
        ...
        return datatables()->eloquent($query)->addIndexColumn()
            ...
            ->addColumn('action', function ($row) {
                return '<div class="dropdown"><button type="button" class="btn btn-sm dropdown-toggle hide-arrow py-0 waves-effect waves-float waves-light" data-bs-toggle="dropdown" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg></button><div class="dropdown-menu dropdown-menu-end" style="">
                    ...
                    <a class="dropdown-item" id="showAllReply"  data-id="' . $row->id . '" href="javascript:;"  data-bs-toggle="modal" data-bs-target="#show_all_reply_model"><i class="fa-regular fa-pen-to-square" style=" margin: 0 0.5rem !important; "></i><span>عرض الردود</span></a>
                    <a class="dropdown-item" id="editRow"  data-id="' . $row->id . '" href="javascript:;"  data-bs-toggle="modal" data-bs-target="#show_edit_model"><i class="fa-regular fa-pen-to-square" style=" margin: 0 0.5rem !important; "></i><span>إضافة رد</span></a>
                   <a class="dropdown-item" id="editRow"  data-id="' . $row->id . '" href="javascript:;"  data-bs-toggle="modal" data-bs-target="#show_edit_model"><i class="fa-regular fa-pen-to-square" style=" margin: 0 0.5rem !important; "></i><span>إغلاق المعاملة</span></a>
     ...
     *
     * @param \App\Models\CustomerPenTreatment $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(CustomerPenTreatment $model)
    {
        return $data = CustomerPenTreatment::whereHas('treatment', function ($quary) {
            $quary->whereHas('users', function ($q) {
    ...
    {
        return $this->builder()
            ->setTableId('customerpentreatment-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            ['title' => __('Name'), 'data' => 'title', 'orderable' => false],
            ['title' => 'المكلف', 'data' => 'customer_id', 'orderable' => false],
            ['title' => 'التفاصيل', 'data' => 'description', 'orderable' => false],
            ['title' => 'أنشئ في', 'data' => 'created_at', 'orderable' => false],
    ...
    {
        return 'CustomerPenTreatment_' . date('YmdHis');
    }
}
